...
class ExceptionsTest {
	...
	@Test
    void nullBubble() throws Exception {
	...
	@Test
    void errorCallbackNotImplementedRejectsNull() {
	...
	@Test
    void isErrorCallbackNotImplemented() {
	...
	@Test
    void allOverflowIsIllegalState() {
	...
	@Test
    void allIllegalStateIsntOverflow() {
	...
	@Test
    void failWithRejectedIsSingleton() {
	...
	@Test
    void failWithRejectedNotTimeCapableIsSingleton() {
	...
	@Test
    void isCancelAndCancelIsBubbling() {
	...
	@Test
    void nullOrNegativeRequestReferencesSpec() {
	...
	@Test
    void propagateDoesntWrapRuntimeException() {
	...
	@Test
    void throwIfFatalThrowsBubbling() {
	...
	@Test
    void throwIfFatalThrowsErrorCallbackNotImplemented() {
	...
	@Test
    void multipleWithEmptyIterable() {
	...
	@Test
    void unwrapMultipleNull() {
		assertThat(Exceptions.unwrapMultiple(null))
				.isEmpty();
	}

	@Test
    void unwrapMultipleNotComposite() {
	...
	@Test
    void addThrowableRace() throws Exception {
		for (int i = 0; i < 10; i++) {
			final int idx = i;
			RaceTestUtils.race(
	...
	@Test
    void addSuppressedToRejectedInstance() {
	...
	@Test
    void addSuppressedToRejectedSingleton1() {
	...
	@Test
    void addSuppressedToRejectedSingleton2() {
	...
	@Test
    void addSuppressedToTERMINATED() {
		Exception suppressed = new IllegalStateException("boom");
	...
	@Test
    void addSuppressedRuntimeToNormal() {
	...
	@Test
    void addSuppressedRuntimeToRejectedInstance() {
	...
	@Test
    void addSuppressedRuntimeToSame() {
		RuntimeException original = new RuntimeException("foo");
	...
	@Test
    void addSuppressedRuntimeToRejectedSingleton1() {
	...
	@Test
    void addSuppressedRuntimeToRejectedSingleton2() {
	...
	@Test
    void failWithRejectedNormalWraps() {
	...
	@Test
    void failWithRejectedSingletonREEWraps() {
	...
	@Test
    void failWithRejectedNormalREEWraps() {
	...
	@Test
    void failWithRejectedReactorREENoOp() {
	...
	@Test
    void unwrapMultipleExcludingTraceback() {
	...
	@Test
    void retryExhaustedMessageWithNoCause() {
	...
	@Test
    void retryExhaustedMessageWithCause() {
